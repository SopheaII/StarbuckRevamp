...
//  StarbuckRevamp
//
//  Created by Sao Sophea on 3/1/24.
//
...
struct ParticleSystem: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> UIView {
        ...
        snowParticles.scale = 0.1
        snowParticles.scaleRange = 0.1
